...
xcopy /s/Y appengine-wordpress-plugin\appengine-plugin wordpress\wp-content\plugins\
xcopy /s/Y appengine-wordpress-plugin\gcs-media-plugin wordpress\wp-content\plugins\
rmdir /s/q batcache\
